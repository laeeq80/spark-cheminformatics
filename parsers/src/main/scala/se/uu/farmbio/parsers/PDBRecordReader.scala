...
object PDBRecordReader {
  val SIZE_PROPERTY_NAME = "se.uu.farmbio.vs.io.PDBRecordReader.size"
  val DEFAULT_SIZE = "30"
}

class PDBRecordReader(private val split: FileSplit, private val job: JobConf) 
  ...
  private val END_TAG: Array[Byte] = "ENDMDL\n".getBytes
  private val size = job.get(PDBRecordReader.SIZE_PROPERTY_NAME,PDBRecordReader.DEFAULT_SIZE).toInt
